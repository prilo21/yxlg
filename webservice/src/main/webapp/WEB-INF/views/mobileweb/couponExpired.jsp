	...
	<body>
		...
		<div class="bg">
			...
			<c:if test="${discountCategory==20}">
    			<div class="hbqg_mid"><img src="/c2mwebservice/resources/public/images/guoqi.png" width="100%"></div>
    		</c:if>
    		<c:if test="${discountCategory==30}">
    			<div class="hbqg_mid"><img src="/c2mwebservice/resources/public/images/guoqi_dzk.png" width="100%"></div>
    		</c:if>
		</div>
		<script>
			$(function(){
