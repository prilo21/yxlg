...
<html>
	...
	<div class="bg">
	    ...
	    <div class="dzk_di">
		        ...
		        <c:forEach items="${result}" var="coupon">
			        <table class="hb" cellpadding="0" cellspacing="0">
			        	<tr>
			            	...
			            	<td width="36%" class="hb_yqq">满<c:out value="${coupon.amountRange}"></c:out>元使用<br><span>有效期至<date:date pattern="yyyy-MM-dd" value="${coupon.ruleEnd}" /></span></td>
			                <td class="hb_zhec">
								...
								<img src="/c2mwebservice/resources/public/images/yuan.png" width="15%"></td>
			                <td width="11%"></td>
			            </tr>
			        </table>
				</c:forEach>
			...
			<c:if test="${discountCategory==30}">
	        	<img class="dzk_fxt" src="/c2mwebservice/resources/public/images/dzk_fxt.png" width="100%" style="margin-left: 25%">
		        <c:forEach items="${rs}" var="coupon">
					<table class="dzk" cellpadding="0" cellspacing="0">
			        	<tr>
			                ...
			                <td class="dzk_zhec">
			                	<!-- 将double类型转为String类型，jstl没有把数字转换为string的标签，比如<ftm:parseString></ftm:parseString>之类 -->
