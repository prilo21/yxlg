...
package com.yxlg.webservice.etag;
 ...
 * @author Marvin.ma
 * 
 * 在Spring原有Etag Filter的基础上重新实现response的update方法。
 * 如果header是304，则responseBody返回固定值"Not Modified"。
 * @since 3.0
 */
	...
	private void updateResponse(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (rawResponse.isCommitted()) {
			...
			if (responseETag.equals(requestETag)) {
				...
				PrintWriter writer = rawResponse.getWriter();
