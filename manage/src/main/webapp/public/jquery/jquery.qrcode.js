    ...
    r.fn.qrcode = function(h) {
        ...
        o.prototype = {
            ...
            makeImpl: function(a, c) {
                ...
                for (var d = 0; d < this.moduleCount; d++) { this.modules[d] = Array(this.moduleCount);
            ...
            getBestMaskPattern: function() {
                for (var a = 0, c = 0, d = 0; 8 > d; d++) { this.makeImpl(!0, d);
        ...
        t.prototype = { get: function(a) {
                return 1 == (this.buffer[Math.floor(a / 8)] >>> 7 - a % 8 & 1) }, put: function(a, c) {
                for (var d = 0; d < c; d++) this.putBit(1 == (a >>> c - d - 1 & 1)) }, getLengthInBits: function() {
                return this.length }, putBit: function(a) {
