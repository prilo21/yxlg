...
public class JsonValidator {
	...
	private boolean error(String type, int col) {
		...
		logger.info("type:" + type + ",col:" + col + ",System line.separator" + System.getProperty("line.separator"));
		return false;
	}
...
//		System.out.println(jsonStr + ":" + new JsonValidator().validate(jsonStr));
	...
	//验证用户名正则表达式，允许为数字、字母、连字符、下划线、中文
	public static boolean checkUserName(String userName) {
		
		String regex = "([a-z0-9_-]|[a-z]|[A-Z]|[0-9]|[\\u4e00-\\u9fa5])+";
