...
public class CommonsMethod {
	...
	public static String getPort() throws Exception {
		...
		int port = ((ServletRequestAttributes) RequestContextHolder
				.getRequestAttributes()).getRequest().getLocalPort();
...
//	}
	...
	// String rootPath =
	// ((ServletRequestAttributes)RequestContextHolder.getRequestAttributes()).getRequest().getServletContext().getRealPath(
	// "");
	// return rootPath;
	// }
	...
	public static String changeISO8859_12UTF8(String noEncodeString) {
		...
		try {
			...
			log.error("changeISO8859_12UTF8异常。",e);
		}
		
		return "";
	}
	
	private static final Logger log = LoggerFactory.getLogger(CommonsMethod.class);
